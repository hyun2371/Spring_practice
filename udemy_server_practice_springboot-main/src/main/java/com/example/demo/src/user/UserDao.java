...
public class UserDao {
    ...
    public GetUserInfoRes selectUserInfo(int userIdx) {
        String selectUserInfoQuery = "select nickname,address from User where userIdx=?";
    ...
    public List<GetOrderInfoRes> selectOrderInfo(int userIdx) {
        String selectOrderInfoQuery = "select orderIdx,payment from Orders where userIdx=?";
